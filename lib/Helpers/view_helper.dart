...
class ViewHelper {
  ...
  static List<BoxShadow> shadowBottomRight() {
    return [
      BoxShadow(
        color: Colors.grey.withOpacity(.2),
        spreadRadius: 1,
  ...
  static List<BoxShadow> shadowBottomLeft() {
    return [
      BoxShadow(
  ...
  static List<BoxShadow> shadowCenter() {
